...
<<<<<<< HEAD
GLOBAL_LIST_INIT(admin_verbs_spawn, list(/datum/admins/proc/spawn_atom, /datum/admins/proc/podspawn_atom, /datum/admins/proc/spawn_cargo, /client/proc/respawn_character, /datum/admins/proc/beaker_panel))
=======
