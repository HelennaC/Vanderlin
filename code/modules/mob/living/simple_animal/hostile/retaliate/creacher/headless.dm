...
/mob/living/simple_animal/hostile/retaliate/headless
	...
	retreat_health = 0.1
<<<<<<< HEAD:code/modules/mob/living/simple_animal/rogue/creacher/headless.dm
	food = 0
	dodgetime = 4 SECONDS
=======
	dendor_taming_chance = DENDOR_TAME_PROB_NONE
	dodgetime = 15
>>>>>>> upstream/main:code/modules/mob/living/simple_animal/hostile/retaliate/creacher/headless.dm
	aggressive = 1
	remains_type = null
	body_eater = TRUE
