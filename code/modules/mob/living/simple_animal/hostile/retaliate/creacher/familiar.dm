...
<<<<<<< HEAD:code/modules/mob/living/simple_animal/rogue/creacher/familiar.dm
...
>>>>>>> upstream/main:code/modules/mob/living/simple_animal/hostile/retaliate/creacher/familiar.dm
	icon_state = "spiritw"
	icon_living = "spiritw"
	icon_dead = null
