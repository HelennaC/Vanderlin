/mob/living/simple_animal/hostile/retaliate/wolf
	...
	retreat_health = 0.4
<<<<<<< HEAD:code/modules/mob/living/simple_animal/rogue/creacher/volf.dm
	food = 0
	dodgetime = 2 SECONDS
=======

	dodgetime = 17
>>>>>>> upstream/main:code/modules/mob/living/simple_animal/hostile/retaliate/creacher/volf.dm
	aggressive = 1
